...
(B) Kshell : 20 out of 20 pts
    What is your kshell command to invoke faber_thread_test(): faber-test
    What is your kshell command to invoke sunghan_test(): sunghan-test
    What is your kshell command to invoke sunghan_deadlock_test(): sunghan-deadlock-test
...
1)  Names and USC e-mail addresses of team members: srikrish@usc.edu (Srikrishna Balasubramanian), khyatigu@usc.edu (Khyati Gupta), suryakan@usc.edu (Suryakant Kumar Kashyap), muskanpa@usc.edu (Muskan Pandey)
